...
* [拦截异常大小贴纸表情](features/chat/block-abnormal-size-stickers.md)
* [聊天输入栏增强](features/chat/chat-input-bar-enhancements.md)
* [聊天工具栏](features/chat/chat-toolbar.md)
* [对话分组](features/chat/conversation-grouping.md)
* [禁用消息折叠](features/chat/disable-message-collapsing.md)
* [禁用置顶聊天折叠](features/chat/disable-pinned-chats-collapsing.md)
* [禁止上传正在输入状态](features/chat/disable-typing-status-uploading.md)
...
* [伪装语音时长](features/chat/fake-voice-duration.md)
* [转发收藏语音](features/chat/forward-favorite-voices.md)
* [隐藏发送消息头像](features/chat/hide-outgoing-messages-avatar.md)
* [清空未读](features/chat/mark-all-as-read.md)
* [Markdown 渲染](features/chat/markdown-rendering.md)
* [合并消息显示](features/chat/merge-messages-into-groups.md)
* [修改文本消息显示](features/chat/modify-text-message-display.md)
* [快捷清除引用](features/chat/quick-remove-quote.md)
* [引用消息直达](features/chat/quoted-message-direct-jump.md)
* [重定向文件下载路径](features/chat/redirect-download-path.md)
* [移除消息菜单项](features/chat/remove-chat-message-context-menu-items.md)
* [移除通话时聊天限制](features/chat/remove-limits-during-calls.md)
* [移除媒体发送数量限制](features/chat/remove-send-media-count-limit.md)
* [消息复读](features/chat/repeat-messages.md)
* [贴纸保存到本地](features/chat/save-stickers-to-local-storage.md)
* [语音保存到本地](features/chat/save-voices-to-local-storage.md)
